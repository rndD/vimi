...
NeoBundle 'Shougo/neobundle.vim'
    ...
    " Interface
        ...
        NeoBundle 'https://github.com/vim-scripts/IndexedSearch.git'
        "NeoBundle 'https://github.com/rphillips/vim-zoomwin.git'
        "NeoBundle 'https://github.com/mattn/zencoding-vim.git'
        NeoBundle 'https://github.com/vim-scripts/UltiSnips.git'
        "NeoBundle 'https://github.com/msanders/snipmate.vim.git'
        "NeoBundle 'https://github.com/miripiruni/vimi-snippets.git'
        ...
        "NeoBundle 'https://github.com/vim-scripts/bufexplorer.zip.git'
        "NeoBundle 'https://github.com/vim-scripts/delimitMate.vim.git'
        "NeoBundle 'https://github.com/sjl/gundo.vim.git'
        "NeoBundle 'https://github.com/edsono/vim-matchit.git'
        NeoBundle 'https://github.com/sjl/splice.vim.git'
        "NeoBundle 'https://github.com/chrismetcalf/vim-yankring.git'
        "NeoBundle 'https://github.com/slack/vim-fuzzyfinder.git'
    ...
    " CSS/LESS
        ...
        NeoBundle 'https://github.com/miripiruni/vim-better-css-indent.git'
        NeoBundle 'https://github.com/miripiruni/CSScomb-for-Vim.git'
    " JavaScript
        NeoBundle 'https://github.com/pangloss/vim-javascript.git'
        NeoBundle 'https://github.com/itspriddle/vim-jquery.git'
        NeoBundle 'https://github.com/kchmck/vim-coffee-script.git'
        NeoBundle 'https://github.com/walm/jshint.vim.git'
    ...
    " Python/Django
        NeoBundle 'https://github.com/fs111/pydoc.vim.git'
    " Perl
